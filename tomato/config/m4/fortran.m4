...
AC_DEFUN([TOM_FC_EXTENSIONS], [
  ...
  AC_FC_SRCEXT(F90, [tom_fc_src_ok="yes"], [tom_fc_src_ok="no"])
  if test "${tom_fc_src_ok}" != "yes"; then
...
# module files.
#
AC_DEFUN([TOM_FC_MOD_CASE],[
  AC_REQUIRE([TOM_FC_EXTENSIONS])
