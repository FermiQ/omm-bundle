...
#ifdef PSP
subroutine omm_pddbc2pdcoo_psp(m,n,H_dim,H_vals,desc_H,S_present,S_dim,S_vals,desc_S,new_S,e_min,D_min_dim,D_min_vals,desc_D_min,&
               calc_ED,eta,C_min_dim,C_min_vals,desc_C_min,init_C,T_present,T_dim,T_vals,desc_T,scale_T,flavour,np,ip,cg_tol,&
               long_out,dealloc,mpi_rank,mpi_size,nprow,order,bs_def,icontxt)
  use omm_params, only : dp, ms_scalapack_running
  use MatrixSwitch
  ...
  call m_register_pdsp_thre(H,H_vals,desc_H,'coo',0.0_dp)
  if (S_present) call m_register_pdsp_thre(S,S_vals,desc_S,'coo',0.0_dp)
  call m_register_pdbc(D_min,D_min_vals,desc_D_min)
  call m_register_pdbc(C_min,C_min_vals,desc_C_min)
  if (T_present) call m_register_pdbc(T,T_vals,desc_T)
...
end subroutine omm_pddbc2pdcoo_psp

subroutine omm_pzdbc2pzcoo_psp(m,n,H_dim,H_vals,desc_H,S_present,S_dim,S_vals,desc_S,new_S,e_min,D_min_dim,D_min_vals,desc_D_min,&
               calc_ED,eta,C_min_dim,C_min_vals,desc_C_min,init_C,T_present,T_dim,T_vals,desc_T,scale_T,flavour,np,ip,cg_tol,&
               long_out,dealloc,mpi_rank,mpi_size,nprow,order,bs_def,icontxt)
  use omm_params, only : dp, ms_scalapack_running
  use MatrixSwitch
...
end subroutine omm_pzdbc2pzcoo_psp
