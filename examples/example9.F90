    ...
    do iscf=1,5
      ...
      do i=1,nk
        ...
        if ((imd>0) .and. (iscf==1) .and. (i>1)) then
          ...
          call omm_pzdbc_spm(m,n,H_dim,H(1,1,i),desc_H,.true.,S_dim,S(1,1,i),desc_S,new_S,e_min(i),D_min_dim,D_min(1,1,i),&
...
#ifdef MPI
      call omm_pzdbc_spm(m,n,H_dim,H(1,1,i),desc_H,.true.,S_dim,S(1,1,i),desc_S,.false.,e_min(i),ED_min_dim,ED_min(1,1,i),&
